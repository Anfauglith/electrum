...
class TestUtil(unittest.TestCase):
    ...
    def test_parse_URI_address_message(self):
        self._do_test_parse_URI('IoP:pGrFzLKTWFUAu9qvVCqWXJ7k4h7tUauugv?message=electrum-iop%20test',
    ...
    def test_parse_URI_multiple_args(self):
        self._do_test_parse_URI('IoP:pGrFzLKTWFUAu9qvVCqWXJ7k4h7tUauugv?amount=0.00004&label=electrum-iop-test&message=electrum-iop%20test&test=none&r=http://domain.tld/page',
                                {'address': 'pGrFzLKTWFUAu9qvVCqWXJ7k4h7tUauugv', 'amount': 4000, 'label': 'electrum-iop-test', 'message': u'electrum-iop test', 'memo': u'electrum-iop test', 'r': 'http://domain.tld/page', 'test': 'none'})
