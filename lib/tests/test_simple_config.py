...
class Test_SimpleConfig(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.electrum_iop_dir = tempfile.mkdtemp()
        # Do the same for the user dir to avoid overwriting the real configuration
        # for development machines with electrum-iop installed :)
        self.user_dir = tempfile.mkdtemp()

        self.options = {"electrum_iop_path": self.electrum_iop_dir}
    ...
    def tearDown(self):
        ...
        shutil.rmtree(self.electrum_iop_dir)
    ...
    def test_simple_config_command_line_overrides_everything(self):
        ...
        sources"""
        fake_read_system = lambda : {"electrum_iop_path": "a"}
        fake_read_user = lambda _: {"electrum_iop_path": "b"}
        read_user_dir = lambda : self.user_dir
        config = SimpleConfig(options=self.options,
                              read_system_config_function=fake_read_system,
                              read_user_config_function=fake_read_user,
                              read_user_dir_function=read_user_dir)
        self.assertEqual(self.options.get("electrum_iop_path"),
                         config.get("electrum_iop_path"))

    def test_simple_config_user_config_overrides_system_config(self):
        """Options passed in user config override system config."""
        fake_read_system = lambda : {"electrum_iop_path": self.electrum_iop_dir}
        fake_read_user = lambda _: {"electrum_iop_path": "b"}
        read_user_dir = lambda : self.user_dir
        config = SimpleConfig(options={},
                              ...
                              read_user_config_function=fake_read_user,
                              read_user_dir_function=read_user_dir)
        self.assertEqual("b", config.get("electrum_iop_path"))

    def test_simple_config_system_config_ignored_if_portable(self):
        """If electrum-iop is started with the "portable" flag, system
    ...
    def test_simple_config_user_config_is_used_if_others_arent_specified(self):
        ...
        fake_read_system = lambda : {}
        fake_read_user = lambda _: {"electrum_iop_path": self.electrum_iop_dir}
        read_user_dir = lambda : self.user_dir
        config = SimpleConfig(options={},
                              read_system_config_function=fake_read_system,
                              read_user_config_function=fake_read_user,
    ...
    def test_cannot_set_options_passed_by_command_line(self):
        ...
        config = SimpleConfig(options=self.options,
                              ...
                              read_user_config_function=fake_read_user,
                              read_user_dir_function=read_user_dir)
        config.set_key("electrum_iop_path", "c")
        self.assertEqual(self.options.get("electrum_iop_path"),
                         config.get("electrum_iop_path"))
    ...
    def test_can_set_options_from_system_config(self):
        ...
        config = SimpleConfig(options={},
                              ...
                              read_user_dir_function=read_user_dir)
        config.set_key("electrum_iop_path", "c")
        self.assertEqual("c", config.get("electrum_iop_path"))
    ...
    def test_can_set_options_set_in_user_config(self):
        ...
        config = SimpleConfig(options={},
                              ...
                              read_user_config_function=fake_read_user,
                              read_user_dir_function=read_user_dir)
        config.set_key("electrum_iop_path", another_path)
        self.assertEqual(another_path, config.get("electrum_iop_path"))
    ...
    def test_user_config_is_not_written_with_read_only_config(self):
        ...
        contents = None
        with open(os.path.join(self.electrum_iop_dir, "config"), "r") as f:
            contents = f.read()
...
"""
    ...
    def setUp(self):
        ...
        self.thefile = tempfile.mkstemp(suffix=".electrum-iop.test.conf")[1]
    ...
    def test_read_system_config_file_does_not_exist(self):
        somefile = "/foo/I/do/not/exist/electrum-iop.conf"
