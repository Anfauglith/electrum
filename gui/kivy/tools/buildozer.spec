...
# (str) Package name
package.name = Fermatum

# (str) Package domain (needed for android/ios packaging)
package.domain = org.fermatum
...
presplash.filename = %(source.dir)s/icons/fermatum.png

# (str) Icon of the application
#icon.filename = %(source.dir)s/icons/fermatum_android_launcher_icon.png
icon.filename = %(source.dir)s/icons/fermatum_launcher.png
...
android.manifest.intent_filters = gui/kivy/tools/iop_intent.xml
